...
function toPascalCaseKeys(obj: Record<string, any>) {
...
export default function Signup() {
  ...
  const handleSubmit = async () => {
    ...
    const payload = toPascalCaseKeys(formData);
    ...
    try {
      ...
      if (!res.ok) throw new Error(json.details || json.message || "Unknown error");
