      ...
      <main className="flex-grow container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12">
            <Card>
              <CardHeader>
                <CardTitle>Why Apply for Your Home Loan with Home Online?</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <h3 className="font-semibold text-lg mb-2">Banks Bid For Your Home Loan</h3>
                    <p className="text-gray-600">
                      Instead of you shopping around, lenders compete for your home loan, offering better rates and
                      higher broker fee estimates.
                    </p>
                  </div>
                  <div>
